...
| [spec-03-vector-vortex-tempest-identity-slice](spec-03-vector-vortex-tempest-identity-slice.md) | vector-vortex | Draft | Tempest identity slice: converging perspective web, per-entity colour, tap-and-repeat movement, an enemy that shoots back, line-fragment destruction, five full-screen presentation states, arcade HUD in a shipped pixel font, and game audio with attribution. One web shape, one wave. Supersedes the timed-survival contract of Spec 01 v3.0 and replaces the superseded topology-shift spec. |
